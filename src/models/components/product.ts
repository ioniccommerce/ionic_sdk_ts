...
import { Link, Link$inboundSchema, Link$Outbound, Link$outboundSchema } from "./link.js";
import {
    ShippingAttribute,
...
/** @internal */
export const Product$inboundSchema: z.ZodType<Product, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const Product$outboundSchema: z.ZodType<Product$Outbound, z.ZodTypeDef, Product> = z
    .object({
